 ...
 * @todo       
 */
class Voucher extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|voucher|';
    public $_cacheName       = 'voucher';
    public $_tableName       = 'voucher';
     ...
     * @access public
     */
    public function getVoucher($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editVoucher($id=null, $field_row)
    {
     ...
     * @access public
     */
    public function editVoucherSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
