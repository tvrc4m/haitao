 ...
 * @todo       
 */
class Shop extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|shop|';
     ...
     * @access public
     */
    public function getShop($userid=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editShop($userid=null, $field_row)
    {
     ...
     * @access public
     */
    public function editShopSingleField($userid, $field_name, $field_value_new, $field_value_old)
    {
     ...
     * @access public
     */
    public function removeShop($userid)
    {
