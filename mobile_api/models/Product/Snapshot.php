 ...
 * @todo       
 */
class Product_Snapshot extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|product_snapshot|';
    public $_cacheName       = 'product';
    public $_tableName       = 'product_snapshot';
     ...
     * @access public
     */
    public function getSnapshot($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editSnapshot($id=null, $field_row)
    {
     ...
     * @access public
     */
    public function editSnapshotSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
     ...
     * @access public
     */
    public function removeSnapshot($id)
    {
