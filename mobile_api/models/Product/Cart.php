 ...
 * @todo       
 */
class Product_Cart extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|product_cart|';
    public $_cacheName       = 'product';
    public $_tableName       = 'product_cart';
     ...
     * @access public
     */
    public function getCart($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editCart($id=null, $field_row)
    {
     ...
     * @access public
     */
    public function editCartSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
