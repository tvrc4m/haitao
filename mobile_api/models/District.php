 ...
 * @todo       
 */
class District extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|district|';
    public $_cacheName       = 'district';
    public $_tableName       = 'district';
     ...
     * @access public
     */
    public function getDistrict($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editDistrict($id=null, $field_row)
    {
     ...
     * @access public
     */
    public function editDistrictSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
