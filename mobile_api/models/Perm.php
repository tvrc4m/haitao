...
class Perm
{
	...
	public static function getUserByCookie()
	{
		...
		if (array_key_exists(self::$cookieId, $_COOKIE))
		{
			...
			$user_rows        = $userModel->getMember($user_id);
		...
		*/
		...
		if (array_key_exists(self::$cookieName, $_COOKIE))
		{
			...
			if ($user_key && isset($user_row['user_id']) && $user_row['user_id'] == @$user_row_default['user_id'])
			{
