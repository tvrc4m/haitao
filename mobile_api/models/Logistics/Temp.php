 ...
 * @todo       
 */
class Logistics_Temp extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|logistics_temp|';
    public $_cacheName       = 'logistics';
    public $_tableName       = 'logistics_temp';
     ...
     * @access public
     */
    public function getTemp($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editTemp($id=null, $field_row)
    {
     ...
     * @access public
     */
    public function editTempSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
