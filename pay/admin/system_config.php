    ...
    <form name="sysconfig" action="system_config.php" method="post" style="margin-top:0px;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
     	 ...
     	 <tr>
            <td align="left">总站全名</td>
            <td align="left"><input class="text" name="web_url_name" type="text" id="web_url_name" size="30" maxlength="60" value="<?php echo $config['web_url_name'];?>"/></td>
        </tr>
        <tr>
            <td align="left">总站URL</td>
            <td align="left"><input class="text" name="web_url" type="text" id="web_url" size="30" maxlength="60" value="<?php echo $config['web_url'];?>"/></td>
        </tr>
