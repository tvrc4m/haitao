    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
		  ...
		  <tr>
            ...
            <td width="86%" align="left" valign="middle" ><a href="http://www.b2b-builder.com">http://www.b2b-builder.com</a></td>
          </tr>
		 <tr>
            <td width="14%" height="10" align="left" valign="middle">支持论坛</td>
            <td width="86%" align="left" valign="middle" ><a href="http://bbs.b2b-builder.com">http://bbs.b2b-builder.com</a></td>
          </tr>
          <tr>
            <td width="14%" height="10" align="left" valign="middle">使用帮助</td>
            <td width="86%" align="left" valign="middle" >http://www.b2b-builder.com/help.php</td>
          </tr>
          <tr>
		  ...
		  <tr>
			...
			<script src="http://www.b2b-builder.com/api.php?url=<?php echo $config[baseurl];?>"></script></td>
          </tr>
        </table>
	</div>
</div>
