...
{   
   ...
   str += '<div Author="alin" class="cdrWatermark" id="cdrWatermark"></div><div id="cdrBody" style="position:absolute;left:0px;top:0px;z-index:2;width:160px;">';
   str += this.getHeader();
   str += this.getBody();   
...
Calendar.prototype.getStyle = function()
{
	...
	str += '.dayOut{padding:1px;border:none;height:16px;font-size:12px;}\n';
