<?php /* Smarty version 2.6.20, created on 2016-04-07 15:09:09
         compiled from transfer.htm */ ?>
<script type="text/javascript" src="script/Validator.js"></script>
<link href="templates/wap/css/pay.css" rel="stylesheet" type="text/css" />
<div class="block">
	<div class="i-block">
    	 <h2>转账到账户<span><a class="withdraw" href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/?m=payment&s=record&mold=2">转账记录</a></span></h2>
    </div>
	<div class="form">
    ...
    <input type="hidden" name="act" value="transfer" />
    	...
    	<dl>
        	<dt>收款人：</dt>
            <dd><input type="text" class="text w210" name="email" id="email" placeholder="邮箱地址" dataType="Require" msg="请填写收款人"/></dd>
        </dl>    
        </fieldset>
        <fieldset>
        <dl>
