<?php /* Smarty version 2.6.20, created on 2016-04-25 18:58:28
...
<section class="banner">
	<div class="user cn-clear">
    	<div class="img"><a href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/settings.php?m=member&s=admin_member&cg_u_type=1"><img height="72" src="<?php if ($this->_tpl_vars['cominfo']['plogo']): ?><?php echo $this->_tpl_vars['cominfo']['plogo']; ?>
<?php else: ?>templates/default/image/avatar.png<?php endif; ?>" /></a></div>
