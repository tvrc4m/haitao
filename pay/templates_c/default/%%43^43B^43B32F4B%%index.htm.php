...
=======
            ...
            <div class="user_account">账户余1额：<em><?php echo $this->_tpl_vars['de']['cash']; ?>
</em>元</div>
        </div>
    </div>
    </div>
