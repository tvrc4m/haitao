...
var dataReflush/* , list = {
	...
	customerList: {
		name: "客户管理",
		href: "erp.php?ctl=Customer_Base&met=index",
		dataRight: "BU_QUERY",
		target: "setting-base"
	},
	vendorList: {
		name: "供应商管理",
		href: "./erp.php?ctl=Vendor_Base&met=index",
		dataRight: "PUR_QUERY",
		target: "setting-base"
	},
	goodsList: {
		name: "商品管理",
		href: "./erp.php?ctl=Goods_Base&met=index",
		dataRight: "INVENTORY_QUERY",
		target: "setting-base"
	},
	storageList: {
		name: "仓库管理",
		href: "./erp.php?ctl=Base_Warehouse&met=index",
		dataRight: "INVLOCTION_QUERY",
		target: "setting-base"
	},
	staffList: {
		name: "职员管理",
		href: "./erp.php?ctl=Base_Employee&met=index",
		dataRight: "",
		target: "setting-base"
	},
	settlementaccount: {
		name: "账户管理",
		href: "./erp.php?ctl=Base_SettlementAccount&met=index",
		dataRight: "SettAcct_QUERY",
		target: "setting-base"
	},
	shippingAddress: {
		name: "发货地址管理",
		href: "./erp.php?ctl=Base_ShippingAddress&met=index",
		dataRight: "DELIVERYADDR_QUERY",
		target: "setting-base"
	},
	customerCategoryList: {
		name: "客户类别",
		href: "./erp.php?ctl=Base_Assist&met=index&typeNumber=customertype",
		dataRight: "BUTYPE_QUERY",
		target: "setting-auxiliary"
	},
	vendorCategoryList: {
		name: "供应商类别",
		href: "./erp.php?ctl=Base_Assist&met=index&typeNumber=supplytype",
		dataRight: "SUPPLYTYPE_QUERY",
		target: "setting-auxiliary"
	},
	goodsCategoryList: {
		name: "商品类别",
		href: "./erp.php?ctl=Base_Assist&met=index&typeNumber=trade",
		dataRight: "TRADETYPE_QUERY",
		target: "setting-auxiliary"
	},
	unitList: {
		name: "计量单位",
		href: "./erp.php?ctl=Goods_UnitType&met=index",
		dataRight: "UNIT_QUERY",
		target: "setting-auxiliary"
	},
	settlementCL: {
		name: "结算方式",
		href: "./erp.php?ctl=Base_SettlementPayType&met=index",
		dataRight: "Assist_QUERY",
		target: "setting-auxiliary"
	},
	assistingProp: {
		name: "辅助属性",
		href: "./erp.php?ctl=Goods_AssistType&met=index",
		dataRight: "FZSX_QUERY",
		target: "setting-auxiliary"
	},
	parameter: {
		name: "系统参数",
		href: "./erp.php?ctl=Base_Config&met=index",
		dataRight: "",
		target: "setting-advancedSetting"
	},
	authority: {
		name: "权限设置",
		href: "./erp.php?ctl=User_Base&met=index",
		dataRight: "",
		target: "setting-advancedSetting"
	},
	operationLog: {
		name: "操作日志",
		href: "./erp.php?ctl=Log_Action&met=index",
