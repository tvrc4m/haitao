...
function(e) {
    ...
    e.ligerui.controls.Tab.ligerExtend(e.ligerui.core.UIComponent, {
        ...
        setTabManageEven: function() {
            ...
            e("#tabManage").click(function() {
                ...
                if (0 === e(".l-tab-menu").length) {
                    var r = '<div class="l-tab-menu"><p id="tabCloseAll" data-opt="closeall"><b></b>关闭全部页</p><p id="tabCloseCur" data-opt="closecur"><b></b>关闭当前页</p><p id="tabRefCur" data-opt="reloadcur"><b></b>刷新当前页</p>';
                    e("#page-tab").append(r);
                    e(".l-tab-menu").css({
                        top: i.top + 30 + "px",
                ...
                $("iframe").contents().click(function(t) {
                    e(".l-tab-menu").hide();
                });
            });
        ...
        moveToPrevTabItem: function() {
            ...
            for (var a = -1 * parseInt(t.tab.links.ul.css("left")), s = 0; s < r.length - 1; s++) if (r[s] < a && r[s + 1] >= a) {
                t.tab.links.ul.animate({
                    left: -1 * parseInt(r[s])
                });
                return
        ...
        moveToNextTabItem: function() {
            ...
            for (var d = -1 * parseInt(t.tab.links.ul.css("left")), c = 1; c < o.length; c++) if (o[c] <= d && o[c - 1] > d) {
                t.tab.links.ul.animate({
        ...
        overrideTabItem: function(t, i) {
            ...
            if (c && u) {
                ...
                d && u.height(d);
                e("a", c).text(n);
                e("iframe", u).attr("src", s).bind("load.tab",
                function() {
                    p.hide();
        ...
        addItem: function(t, i) {
            ...
            if (t) {
                ...
                if (t.line) i.items.append('<div class="l-menu-item-line"></div>');
                    ...
                    t.icon && s.prepend('<div class="l-menu-item-icon l-icon-' + t.icon + '"></div>'); (t.disable || t.disabled) && s.addClass("l-menu-item-disable");
                    if (t.children) {
