(function($){$.fn.imagezoom=function(options){var settings={xzoom:460,yzoom:460,offset:10,position:"BTR",preload:1};if(options){$.extend(settings,options);}
...
$("div.zoomDiv").css({top:324,left:leftpos});$("div.zoomDiv").width(settings.xzoom);$("div.zoomDiv").height(settings.yzoom);$("div.zoomDiv").show();$(this).css('cursor','crosshair');$(document.body).mousemove(function(e){mouse=new MouseEvent(e);if(mouse.x<imageLeft||mouse.x>imageLeft+imageWidth||mouse.y<imageTop||mouse.y>imageTop+imageHeight){mouseOutImage();return;}
