...
class cls_image
{
    ...
    function make_thumb($img, $path = '',$thumb_width = 0, $thumb_height = 0,  $bgcolor='')
    {
		...
		if($this->watermark)
		{	
			include($config['webroot']."/config/watermark_config.php");
			if($thumb_width>400 && (isset($watermark_config['wmark_type']) && $watermark_config['wmark_type']!=0))
			{
				...
				else if($watermark_config['wmark_type']==2)
					$this->imageWaterMark($img,$watermark_config['wmark_locaction'],"",$watermark_config['wmark_words'],14,$watermark_config['wmark_words_color']); 
			}
		}
		//========================================================
