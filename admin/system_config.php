      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td align="left"><input class="text" name="baseurl" type="text" id="baseurl" value="<?php echo $config['baseurl'];?>" size="30">
            <span class="bz">不带http://,不带www,只填写最后面一部分如：b2b-builder.com,或留空。填写错误将无法登录</span></td>
        </tr>
        <tr>
          <td align="left">网站LOGO</td>
          <td align="left"><input class="text" name="logo" type="text" id="logo" value="<?php echo $config['logo'];?>" size="30">
            [<a href="javascript:uploadfile('上传LOGO','logo',230,45,'')">上传</a>] 
            [<a href="javascript:preview('logo');">预览</a>]
            [<a onclick="javascript:$('#logo').val('');" href="#">删除</a>] </td>
        </tr>
       
        <tr>
            <td class="body_left" align="left">支付名称</td>
            <td width="85%" align="left"><input class="text" name="pay_name" type="text" id="pay_name" size="30" maxlength="60"  value="<?php echo $config['pay_name'];?>"/>
            </td>
        </tr>
        <tr>
            <td align="left" >支付地址</td>
            <td align="left" ><input class="text" name="pay_url" type="text" id="pay_url" size="30" maxlength="60" value="<?php echo $config['pay_url'];?>"/></td>
        </tr>
