...
<div class="bigbox">
  ...
  <div class="bigboxbody">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <form method="post" enctype="multipart/form-data"  action="mail_send.php" name="mailsend">
              <tr>
    ...
    <input type="hidden" name="area" id="id_3" value="<?php echo getdistrictid($de["area"]); ?>" />
        ...
        <select id="select_1" size="10" onChange="district(this);">
        <option value="">--请选择--</option>
		<?php echo GetDistrict(); ?>
        </select>
        
        <select id="select_2" size="10" onChange="district(this);" class="hidden"></select>
        <select id="select_3" size="10" onChange="district(this);" class="hidden"></select>
        </div>
...
<textarea name="con" style="width:90%; height:400px;"></textarea>
                </td>
              </tr>
              <tr>
                <td width="16%" style="border-bottom:none;">&nbsp;</td>
                <td width="84%" style="border-bottom:none;">
                <input class="btn" type="submit" value="<?php echo lang_show('send_mail');?>" >
