...
<div class="bigbox">
	...
	<table width="100%" cellspacing="0">
		...
		<tr class="theader">
			<td colspan="2"  align="left" >UCenter</td>
		</tr>
		<tr>
			<td  align="left" >是否开启</td>
			<td align="left" >
				<input type="radio" class="radio" name="ucenter_connect" value="1" <?php if($reg_config['ucenter_connect']==1) echo 'checked="checked"';?> />是
				<input name="ucenter_connect" type="radio" class="radio" value="0" <?php if($reg_config['ucenter_connect']==0) echo 'checked="checked"';?> />否&nbsp;
				</td>
		</tr>
		<tr>
			<td width="16%"  align="left" >UCenter Url</td>
			<td width="84%" align="left" >
				<input class="text" name="ucenter_url" type="text" id="ucenter_url" value="<?php echo $reg_config['ucenter_url'];?>"></td>
		</tr>
		<tr>
			<td align="left">KEY</td>
			<td align="left" ><input class="text" name="ucenter_key" type="text" id="ucenter_key" value="<?php echo $reg_config['ucenter_key'];?>"></td>
		</tr>
          ...
          <td width="84%" align="left" >
            <input class="text" name="qq_app_id" type="text" id="qq_app_id" value="<?php echo $reg_config['qq_app_id'];?>"></td>
				...
				<tr class="theader">
					<td colspan="2" align="left">微信互联</td>
				</tr>
				<tr>
					<td  align="left" >是否开启</td>
					<td align="left" >
						<input type="radio" class="radio" name="weixin_connect" value="1" <?php if($reg_config['weixin_connect']==1) echo 'checked="checked"';?> />是&nbsp;&nbsp;&nbsp;
						<input name="weixin_connect" type="radio" class="radio" value="0" <?php if($reg_config['weixin_connect']==0) echo 'checked="checked"';?> />否&nbsp;
						[<a href="http://open.weixin.qq.com">审请API</a>]
					</td>
				</tr>
				<tr>
					<td align="left">App Key</td>
					<td align="left" ><input name="weixin_app_id" type="text" id="weixin_app_id" class="text" value="<?php echo $reg_config['weixin_app_id'];?>"></td>
				</tr>
				<tr>
					<td align="left">App Secret</td>
					<td align="left" ><input name="weixin_key" type="text" id="weixin_key" class="text" value="<?php echo $reg_config['weixin_key'];?>"></td>
				</tr>
