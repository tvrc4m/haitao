...
<div class="bigbox">
  <div class="bigboxbody">
    <?php
		$sql="select a.user,a.lastLoginTime,a.email,a.name as contact,b.company from ".MEMBER." a left join ".SHOP." b on  
        ...
        if($db->num_rows()>0)
        {
            ...
            foreach($re as $v)
			{
			 ...
			 else
			 {
				...
				//操作记录入库
                 $sql="select a.user,a.lastLoginTime,a.email,a.name as contact,b.company from ".MEMBER." a, ".SHOP." b where 
		 ...
		 {
             $sql="select count(*) as totalsend from ".MEMBER." a, ".SHOP." b where a.userid=b.userid and a.email<>'' $sqlw ";
             $db->query($sql);
			 $re=$db->fetchRow();
