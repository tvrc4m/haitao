...
<div class="bigbox">
  ...
  <div class="bigboxbody">
    <table width="100%" border="0" cellpadding="1" cellspacing="0">
      <tr class="theader">
        <td width="10%" align="left" ><?php echo lang_show('ttime');?></td>
        <td width="30%" align="left" ><?php echo lang_show('tpurls');?></td>
        ...
        <td width="7%" align="left" ><?php echo lang_show('tregusers');?></td>
        <td width="6%" align="left" ><?php echo lang_show('tpros');?></td>
        <td width="5%" align="left" ><?php echo lang_show('tnews');?></td>
