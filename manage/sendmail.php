...
if(isset($_POST["action"]))
{
	...
	$db->query("select a.lastLoginTime,a.user,b.company,a.name as contact,a.email from ".MEMBER." a,".SHOP." b 
...
//============================
$db->query("select a.email,b.company from ".MEMBER." a left join ".SHOP." b on a.userid=b.userid where a.userid='$_GET[userid]'");
$userd=$db->fetchRow();
//============================
if(isset($_GET["modid"]))
{
