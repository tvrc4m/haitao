...
$request_rows =
	array (
		'OrderCode' => '012657018199',  //订单编号
		'ShipperCode' => 'YTO',         //物流公司编码
		'LogisticCode' => 'YTO'         //物流单号
	);

//echo $api->cancelOrderOnlineByJson($request_rows);
...
//echo $api->getOrderTracesByJson($request_rows);
...
//echo $api->createWayBillOnlineByJson($request_rows);
...
class Api_KdNiao
{
	...
	public function __construct($e_business_id='1256046', $app_key='0011e81b-2ae7-4fe1-a775-090544e1ded7', $req_url = 'http://112.74.112.208:8085/api/oorderservice/')
	{
