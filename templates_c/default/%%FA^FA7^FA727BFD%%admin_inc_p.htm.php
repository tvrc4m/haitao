<?php /* Smarty version 2.6.20, created on 2016-03-17 09:58:50
         compiled from admin_inc_p.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'admin_inc_p.htm', 54, false),array('modifier', 'explode', 'admin_inc_p.htm', 86, false),)), $this); ?>
...
/image/logo.gif<?php endif; ?>" /></a>
        ...
        <div id="nav">
            ...
            <li><a <?php if (((is_array($_tmp=$this->_tpl_vars['menu']['personal']['action'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 4, '') : smarty_modifier_truncate($_tmp, 4, '')) == 'http'): ?>target="_blank"<?php endif; ?> href="<?php if (((is_array($_tmp=$this->_tpl_vars['menu']['personal']['action'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 1, '') : smarty_modifier_truncate($_tmp, 1, '')) != '?' && ((is_array($_tmp=$this->_tpl_vars['menu']['personal']['action'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 4, '') : smarty_modifier_truncate($_tmp, 4, '')) != 'http'): ?>?action=<?php endif; ?><?php echo $this->_tpl_vars['menu']['personal']['action']; ?>
"><?php echo $this->_tpl_vars['menu']['personal']['name']; ?>
</a></li>
...
?>
                <?php if ($this->_tpl_vars['num'] != 'inquire'): ?>
