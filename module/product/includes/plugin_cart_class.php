...
class cart
{
	...
	function get_prolist($seller_id=NULL,$area,$product_id = '',$provinceid = '')
	{
		...
		b.subhead,b.brand,b.type,b.promotion_id,b.ship_free_id,b.trade,b.is_shelves,b.status,b.market_price,b.price as pprice,b.stock as amount,b.name as pname,b.pic,b.catid,b.id as pids,b.freight_id as freight,b.freight_type,b.is_invoice,
		...
		{   
			...
			$re[$k]["activity_rule"]=$val["activity_rule"];
