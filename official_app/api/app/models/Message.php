...
class Message extends Yf_Model
{
     ...
     * @access public
     */
    public function getMessage($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editMessage($id=null, $field_row)
    {
     ...
     * @access public
     */
    public function editMessageSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
