...
if (CHE)
{
    ...
    $config_cache['time'] = array(
        'cacheType' => 2,
        'cacheDir' => APP_PATH . '/data/cache/time_cache/',
        'memoryCaching' => false,
        'automaticSerialization' => true,
        'hashedDirectoryLevel'      => 2,
        'lifeTime' => 0
    ...
    $config_cache['redis_data'] = array(
        'cacheType' => 3,
        'cacheDir' => APP_PATH . '/data/cache/redis_data_cache/',
        'memoryCaching' => false,
        'automaticSerialization' => true,
        'hashedDirectoryLevel'      => 2,
        'lifeTime' => 0
...
//初始化参数
//require_once(INI_PATH . '/init.php');ios_download_url
